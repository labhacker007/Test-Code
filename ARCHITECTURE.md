...
│  │  (Cursor, VS     │       │  • Package Scanner      │   │
│  │   Code, etc.)    │       │  • Extension Scanner    │   │
│  └──────────────────┘       │  • AI Tool Monitor      │   │
│  ┌──────────────────┐       │  • Policy Engine        │   │
│  │  Package Mgrs    │──────>│  • Rule Cache (<1ms)    │   │
│  │  (npm, pip)      │       │  • Event Transport      │   │
│  └──────────────────┘       └──────────┬──────────────┘   │
│                                        │ TLS              │
└────────────────────────────────────────┼──────────────────┘
                                         │
...
│                                                             │
│  ┌─────────────┐  ┌──────────────┐  ┌─────────────────┐   │
│  │  Ingestion  │─>│   Analysis   │─>│  OCSF Export    │   │
│  │     API     │  │  • Rules     │  │  (SIEM/XDR)     │   │
│  │  + WebSocket│  │  • Reputation│  └─────────────────┘   │
│  └──────┬──────┘  └──────┬───────┘                         │
│         │                 │                                 │
│         v                 v                                 │
│  ┌──────────────────────────────────────────────────────┐  │
...
- Modern React dashboard with live monitoring
- Ollama integration for LLM analysis (optional)
